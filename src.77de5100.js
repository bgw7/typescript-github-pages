...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"model/TickInputHandler.ts":[function(require,module,exports) {
"use strict";
...
exports.TickInputHandler = TickInputHandler;
},{}],"index.ts":[function(require,module,exports) {
"use strict";

exports.__esModule = true;

var TickInputHandler_1 = require("./model/TickInputHandler");
...
window.onload = function () {
  ...
  possibleEvents.forEach(function (eventName) {
    ticksInput.addEventListener(eventName, function (ev) {
      ...
      var handler = new TickInputHandler_1.TickInputHandler();
      handler.showResult(inputElement);
    });
  });
};
},{"./model/TickInputHandler":"model/TickInputHandler.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
